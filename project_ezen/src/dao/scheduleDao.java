...
//	public static ArrayList<scheduleDto> list() {
...
//	        String query = "select * from gym_schedule order by schedule_idx desc";
//			rs = stmt.executeQuery(query); //쿼리문 실행
//			
//			while( rs.next() ) {
//	            int schedule_idx = rs.getInt("schedule_idx");
//	            String schedule_content = rs.getString("schedule_content");
//	       
//	            System.out.println("schedule_idx"+schedule_idx);
//	            System.out.println("schedule_content"+schedule_content);
//	            
//	            scheduleDto dto = new scheduleDto(schedule_idx, schedule_content);
//	            
//	            list.add(dto);
//	        }
//			
...
//	            int schedule_member_idx = rs.getInt("schedule_member_idx");
...
////	스케쥴 수정
//	public static scheduleDto schedule_update(HttpServletRequest request) {
//		Connection conn = null; 
//	    PreparedStatement pstmt = null; 
//		scheduleDto dto = null;
//        String schedule_idx = request.getParameter("member_idx");//매개변수 입력 편하게 함. 
...
//        try {
//        	conn = DBConnection.getConnection();
//			String query = "update gym_schedule set gym_schedule_content = ?,gym_mon101 = ?, gym_mon102 = ?, gym_mon103 = ?, gym_mon104 = ?, gym_tue101 = ?, gym_tue102 = ?, gym_tue103 = ?, gym_tue104 = ?, gym_wed101 = ?, gym_wed102 = ?, gym_wed103 = ?, gym_wed104 = ?, gym_thu101 = ?, gym_thu102 = ?, gym_thu103 = ?, gym_thu104 = ?, gym_fri101 = ?, gym_fri102 = ?, gym_fri103 = ?, gym_fri104 = ?, gym_sat101 = ?, gym_sat102 = ?, gym_sat103 = ?, gym_sat104 = ?, gym_sun101 = ?, gym_sun101 = ?, gym_sun102 = ?, gym_sun103 = ?, gym_sun104 = ? where gym_schedule_idx=?";
//        	System.out.println(query);
//        	pstmt = conn.prepareStatement( query  );
//        	pstmt.setInt(1, Integer.parseInt( schedule_idx )); //첫번째 인자(물음표)
//        	rs = pstmt.executeQuery(); //select
...
//        	while( rs.next() ) {	
//        		int gym_schedule_idx = rs.getInt("gym_schedule_idx");
//	            String gym_schedule_contents = rs.getString("gym_schedule_content");
//	            String gym_mon101 = rs.getString("gym_mon101");
//	            String gym_mon102 = rs.getString("gym_mon102");
//	            String gym_mon103 = rs.getString("gym_mon103");
//	            String gym_mon104 = rs.getString("gym_mon104");
...
////	글쓰기 수정
//	public static void modify( String gym_schedule_idx, String gym_schedule_content, String gym_mon101, String gym_mon102) {
//		Connection conn = null;    
//        PreparedStatement pstmt = null; 
//        try {
//			conn = DBConnection.getConnection();
//			String query = "UPDATE gym_schedule SET gym_mon101=?, gym_mon102=?"
//								+ "gym_schedule_content WHERE gym_schedule_idx=?"; 
//			pstmt = conn.prepareStatement( query );
//			pstmt.setString(1, gym_mon101); //1부터 시작
//			pstmt.setString(2, gym_mon102);
//			pstmt.setString(3, gym_schedule_content);
//			pstmt.setInt(4, Integer.parseInt( gym_schedule_idx ) );
//		
//	        	int result = pstmt.executeUpdate();
//        }
//        catch( Exception e ) {
