...
public class PayDto {
	...
	public PayDto(int pay_idx, String pay_name, String pay_membership, int pay_coupon_num, int pay_amount,
			String pay_start_date, String pay_end_date, Date pay_payment_date, int pay_member_idx) {
		super();
