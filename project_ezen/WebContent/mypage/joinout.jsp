  ...
  <div class="mypage_wrap">
      ...
      <div class="joinout">
         ...
         <div class="joinout_content">
           <h5><small class="payment_small">▌</small>회원탈퇴 안내</h5>
         ...
         <div class="joinout_content">
           <h5><small class="payment_small">▌</small>회원탈퇴 시 꼭 확인해 주세요.</h5>
           <div class="joinout_01">
         ...
         <form name="joinout" method="post" action="joinoutAction.do" > 
	         ...
	         <div class="joinout_contentA">
	           <h5><small class="payment_small">▌</small>탈퇴사유를 선택해 주세요.</h5>
	           <div class="joinout_01">
	         ...
	         <div class="joinout_content">
	           <h5><small class="payment_small">▌</small>개선 사항이 있다면 의견을 남겨 주세요.</h5>
	         ...
	         <div class="joinout_contentB">
	           <h5><small class="payment_small">▌</small>비밀번호 입력</h5>
