	 ...
	 <div class="mypage_menu">
		<table class="mypage_menutable">
			<tbody>
				...
				<tr>
					<th><a href="/project_ezen/mypage/mypage_modify.do?member_idx=${member_idx}"> > 개인정보 수정</a> <br>
	  ...
	  <form name="mypage_memModify" method="post" action="myMemModify.do">
		...
		<table class="mypage_modify_table">
			<tbody>
				...
				<tr>
					<th>전화번호</th>
					<td><input type="text" id="modify_box3" name="tel" placeholder="숫자만 입력" value="${dto.member_phone}"></td>
				</tr>
				<tr>
					<th>생년월일</a></th>
					<td>
						<input class="choice_date" type="date" id="modify_box4" name="choice_date" value="${dto.member_birth_date}">
					</td>
				</tr>
				<tr>
					<th>이메일</th>
					<td><input type="text" id="modify_box5" name="email" value="${dto.member_email}"></td>
				</tr>
				<tr>
					<th>메일 수신여부</th>
		...
		<table class="mypage_pass">
			<tbody>
				<tr>
					<!-- <th></th> -->
					<th>비밀번호입력&nbsp;&nbsp;&nbsp;&nbsp;<input type="password" name="modify_pw" id="modify_box6"></th>
				</tr>
				<%
				...
				<tr>
					<td>
						<div class="submit">
							<input class="modify_submit" type="submit" value="수정">&nbsp;&nbsp;&nbsp;
