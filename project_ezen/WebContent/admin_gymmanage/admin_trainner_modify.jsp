	...
	<div class="admin_tmsection_section-text1"><small class="admin_tm_small">▌</small>트레이너 소개</div>
      ...
      <div class="admin_tmfileup">
          <form action="fileupload.do" method="post" enctype="multipart/form-data">
           ...
           <a href="/project_ezen/main.jsp"><input class="tm_btnC" type="button" name="tm_btnC" value="수정"/></a>
           <a href="/project_ezen/admin_gymmanage/admin_trainner.jsp"><input class="tm_btnC" type="button" name="tm_btnD" value="목록으로"/></a>
           </div>  
    </div>
  </div>
