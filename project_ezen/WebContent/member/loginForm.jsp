				...
				<div class="login">
					...
					<ul>
						<li>
							...
							tabindex="1" placeholder="아이디" id="member_id">
				        ...
				        <%
				        int loginResult = (Integer)session.getAttribute("loginResult") == null? 1:(Integer)session.getAttribute("loginResult"); 
				        
						System.out.println("로그인페이지 : "+loginResult);
