...
%> 
  ...
  <div class="guide_wrap">
    ...
    <div class="guide_B">
      ...
      <form class="guideform" name="guideform" action="guide.do" method="post" onsubmit="return guidecheck()">
        <input type="hidden" name="member_idx" value="${member_idx}">
        <input class="guide_btn" type="submit" value="확인"/>
      </form>
    </div>
  ...
  <script>
    function guidecheck() {
      var g = document.guideform;
    	
      if(g.member_idx.value == "") {
      ...
      if(g.member_idx.value != "") {
    	g.action = "/project_ezen/payment/choice.do";
    	return true;
  	  }	
    }
  </script>
