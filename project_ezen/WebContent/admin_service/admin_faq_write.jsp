...
%>  
  ...
  <div class="admin_faq_write_wrap">
    ...
    <div class="admin_faq_write_content">
      <form name="fwrite" method="post" action="fwrite">
        <table class="admin_faq_write_table">
          <tr>
            <th>제목</th>
            <td class="admin_faq_write_td">
              <input class="ftitle" type="text" name="ftitle" placeholder="제목을 입력해 주세요!">
            </td>
          </tr>
          <tr>
            <td colspan="2">
        ...
        <div class="fbuttons">
		  ...
		  <a href="admin_faq.jsp">
            <input class="fwritebutton" type="button" value="취소"/>
          </a>	
	    </div>
      </form>
    </div>
